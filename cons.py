...
cutscenes = [{'x': 827, 
               ...
               'colour': yellow,
                ...
                {'x': 827, 
                'y': 529, 
                'movement': [None, None, None, None, None, None, None, 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', None, None, None, 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', None, None, None, 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', None, None, None, 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', None, None, None],
                'index': 4,
                'map': 0,
                'text': instructions4,
               'colour': yellow,
