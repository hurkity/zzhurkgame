...
bigtext1 = ["PRESS SPACE TO CONTINUE",
"EMILY: Ohhh my goodness… My entire body hurts…",
"ADAM: Right?",
...
instructions2 = ["Press E to interact with this funky bunny."]
...
narration = ["NARRATOR: Now would be a good time",
"to get to know the townspeople!"]
...
finalfight = ["EMCY: Here’s your shovel, Ivy.",
"IVY: Oh, hey Emcy! Thanks, man.",
"ADAM: Oh, everyone’s here. What’s happening?",
"Are we having an outdoor party?",
"Wait, can parties be outdoor, or are those all barbecues…",
"what’s the overlap here….",
"LOUISE: Hmph. Personally, I’m not too concerned but",
"apparently Evangeline has something she wants to tell us.",
...
cutscenes = [{'x': 827, 
               ...
               'colour': yellow,
                ...
                {'x': 948,
                'y': 860,
                'movement': ['right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right'],
                'index': 13,
                'map': 2,
                'text': None,
               'colour': white,
               ...
               'colour': white,
                ...
                {'x': 500,
                'y': 850,
                'movement': ['left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left'],
                'index': 15,
                'map': 2,
                'text': None,
               'colour': white,
               ...
               'colour': white,
                ...
                {'x': 550,
                'y': 550,
                'movement': ['left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'left', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd'],
                'index': 17,
                'map': 2,
                'text': None,
               'colour': white,
               ...
               'colour': white,
                ...
                {'x': 900, 
                'y': 500, 
                'movement': ['fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd', 'fwd'],
                'index': 20,
                'map': 2,
                'text': cutscene2,
               'colour': white,
               ...
               'colour': yellow,
                ...
                {'x': 210, 
                'y': 715, 
                'movement': ['bwd', 'bwd', 'bwd', 'bwd', 'bwd', 'right', 'right', 'right', 'right'],
                'index': 24,
                'map': 3,
                'text': forest1,
               'colour': white,
