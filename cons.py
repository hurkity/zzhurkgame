...
cutscenes = [{'x': 827, 
               ...
               'colour': yellow,
                ...
                {'x': 980,
               'y': 700, 
               'movement': ['right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'right', 'bwd', 'bwd', 'bwd', 'bwd', 'bwd'],
               'index': 8,
               'map': 1,
               'text': hotel1,
               'colour': white,
